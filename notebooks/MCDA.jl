...
# ╔═╡ e8d241b8-3f16-4a8b-99b7-270cbfea2fbd
using PrettyTables
...
# Armamos la tabla inicial de comparaciones entre criterios. Cada uno representa la comparción de i con j. Por ejemplo, "Impacto" es 3 veces más importante que "Cooperación".
...
# ╔═╡ d46c7924-08a2-4e10-9639-869d8695a970
scs = valor_soporte.VC_vs_MR

# ╔═╡ f8b6d499-6f76-4fe2-8c59-af58444f4a78
...
# ╔═╡ fe2b6479-e991-4cf6-b2a0-e12eccae58da
nombres_proyectos = [
    "Corredor pacífico de integración logística Mesoamericana",
    "Conglomerado portuario del Caribe",
    "Integración eléctrica latinoamericana",
...
# ╔═╡ 8e51e5f4-bd64-4207-9ddf-f6ef1c62343e
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "a98bed43da6949d0bc8d69511bdbbee28779a002"
